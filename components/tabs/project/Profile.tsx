export default function Profile() {
  const backgroundImage = '/projects/profile.png';
  const projectLink = 'https://github.com/shio265/Profile';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <h3 className="text-xl font-semibold mb-2">This Site</h3>
        <p className="text-muted-foreground text-sm">
            Personal website built with Next.js + Lanyard API
        </p>
      </div>
    </a>
  );
